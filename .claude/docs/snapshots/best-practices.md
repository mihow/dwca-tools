...
| --- | --- | --- |
| **Provide verification criteria** | *”implement a function that validates email addresses"* | *"write a validateEmail function. example test cases: [[email protected]](/cdn-cgi/l/email-protection#2d585e485f6d48554c405d4148034e4240) is true, invalid is false, [[email protected]](/cdn-cgi/l/email-protection#1a6f697f685a34797577) is false. run the tests after implementing”* |
